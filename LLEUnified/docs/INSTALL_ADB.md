...
```powershell
Get-FileHash -Algorithm SHA256 ".\LLE64-1.0.4.2-64-bit.apk"
```

On macOS:

```shell
shasum -a 256 "./LLE64-1.0.4.2-64-bit.apk"
```

On Linux:

```shell
sha256sum "./LLE64-1.0.4.2-64-bit.apk"
```
...
```shell
adb install -r "LLE64-1.0.4.2-64-bit.apk"
```
